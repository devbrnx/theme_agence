...
class Soliloquy_Posttype_Admin {
    ...
    public function __construct() {
        ...
        add_filter( 'manage_edit-soliloquyv2_columns', array( $this, 'soliloquy_columns' ) );
        add_filter( 'manage_soliloquyv2_posts_custom_column', array( $this, 'soliloquy_custom_columns' ), 10, 2 );
    ...
    public function messages( $messages ) {
        ...
        $messages['soliloquyv2'] = apply_filters( 'soliloquy_messages',
            array(
                0  => '',
    ...
    public function menu_icon() {
        ...
        ?>
        <style type="text/css">#menu-posts-soliloquyv2 .wp-menu-image img { width: 16px; height: 16px; }</style>
        <?php
