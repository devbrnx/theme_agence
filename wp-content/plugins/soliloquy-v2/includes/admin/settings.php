...
class Soliloquy_Settings {
    ...
    public function __construct() {
        ...
        add_filter( 'plugin_action_links_' . plugin_basename( plugin_dir_path( dirname( dirname( __FILE__ ) ) ) . 'soliloquyv2.php' ), array( $this, 'settings_link' ) );
    ...
    public function admin_menu() {
        ...
        $this->hook = add_submenu_page(
            'edit.php?post_type=soliloquyv2',
                    ...
                    <tr id="soliloquy-settings-key-box">
                        ...
                        <td>
                            <form id="soliloquy-settings-verify-key" method="post">
                                <input type="password" name="soliloquy-license-key" id="soliloquy-settings-key" value="<?php echo ( $this->base->get_license_key() ? md5( $this->base->get_license_key() ) : '' ); ?>" />
    ...
    public function settings_link( $links ) {
        ...
        $settings_link = sprintf( '<a href="%s">%s</a>', add_query_arg( array( 'post_type' => 'soliloquyv2', 'page' => 'soliloquy-settings' ), admin_url( 'edit.php' ) ), __( 'Settings', 'soliloquy' ) );
