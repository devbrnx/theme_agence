...
class Soliloquy_Metaboxes {
    ...
    public function meta_box_scripts( $hook ) {
        ...
        if ( isset( get_current_screen()->post_type ) && 'soliloquyv2' == get_current_screen()->post_type ) {
    ...
    public function get_plupload_init( $post_id ) {
        ...
        $plupload_init = array(
        	...
        	'resize'              => array(
        	    'width'   => Soliloquy_Media::get_instance()->get_resize_width(),
        	    'height'  => Soliloquy_Media::get_instance()->get_resize_height(),
        	    'quality' => 100,
        	    'enabled' => true
        	)
        );
    ...
    public function remove_all_the_metaboxes() {
        ...
        $pass_over  = array( 'submitdiv', 'soliloquyv2' );
    ...
    public function meta_helper( $post, $slider_data ) {
        ...
        <div class="soliloquy-meta-helper <?php echo $class; ?>">
            ...
            <div class="soliloquy-meta-information">
                <p><?php _e( 'You can place this slider anywhere into your posts, pages, custom post types or widgets by using the shortcode(s) below:', 'soliloquy' ); ?></p>
                ...
                <?php endif; ?>
                <p><?php _e( 'You can also place this slider into your template files by using the template tag(s) below:', 'soliloquy' ); ?></p>
            ...
            <table class="form-table">
                <tbody>
                    ...
                    <tr id="soliloquy-config-mobile-size-box" style="display:none;">
                        ...
                        <td>
                            <input id="soliloquy-config-mobile-width" type="number" name="_soliloquy[mobile_width]" value="<?php echo $this->get_config( 'mobile_width', $this->get_config_default( 'mobile_width' ) ); ?>" /> &#215; <input id="soliloquy-config-mobile-height" type="number" name="_soliloquy[mobile_height]" value="<?php echo $this->get_config( 'mobile_height', $this->get_config_default( 'mobile_height' ) ); ?>" /> <span class="soliloquy-unit"><?php _e( 'px', 'soliloquy' ); ?></span>
    ...
    public function save_meta_boxes( $post_id, $post ) {
        ...
        $settings['config']['position']      = preg_replace( '#[^a-z0-9-_]#', '', $_POST['_soliloquy']['position'] );
        ...
        if ( isset( $post->post_type ) && 'soliloquyv2' == $post->post_type ) {
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="soliloquy-thumb-box-<?php echo $id; ?>" class="soliloquy-thumb" valign="middle">
                                                ...
                                                <td>
                                                    ...
                                                    <p class="description"><?php _e( 'The thumbnail URL to be used as a placeholder for the video slide.', 'soliloquy' ); ?></p>
                                                </td>
                                            </tr>
    ...
    public function get_skipped_posttypes() {
        ...
        return apply_filters( 'soliloquy_skipped_posttypes', array( 'attachment', 'revision', 'nav_menu_item', 'envira', 'soliloquy' ) );
