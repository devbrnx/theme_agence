...
final class Plugify_Clean_Testimonials {
	...
	public function __construct () {
        ...
        //Special action to remove featured image metabox
        add_action( 'do_meta_boxes', array( __CLASS__, 'remove_image_box' ) );
	...
	*/
	...
	public static function init () {
		...
		$post_type_labels = array(
			'name' => __( 'Clients', 'clean-testimonials' ),
			'singular_name' => __( 'Client', 'clean-testimonials' ),
			'add_new' => __( 'Add New Clients', 'clean-testimonials' ),
			'add_new_item' => __( 'Add New Client', 'clean-testimonials' ),
			'edit_item' => __( 'Edit Client', 'clean-testimonials' ),
			'new_item' => __( 'New Client', 'clean-testimonials' ),
			'view_item' => __( 'View Client', 'clean-testimonials' ),
			'search_items' => __( 'Search Clients', 'clean-testimonials' ),
			'not_found' =>  __( 'No Clients found', 'clean-testimonials' ),
			'not_found_in_trash' => __( 'No Clients found in the trash', 'clean-testimonials' ),
			'parent_item_colon' => ''
		);
		...
		$taxonomy_labels = array(
			'name' => __( 'Client Categories', 'clean-testimonials' ),
			'singular_name' => __( 'Client Category', 'clean-testimonials' ),
			'search_items' =>  __( 'Search Client Categories', 'clean-testimonials' ),
			'all_items' => __( 'All Client Categories', 'clean-testimonials' ),
			'parent_item' => __( 'Parent Client Categories', 'clean-testimonials' ),
			'parent_item_colon' => __( 'Parent Client Category', 'clean-testimonials' ),
			'edit_item' => __( 'Edit Client Category', 'clean-testimonials' ),
			'update_item' => __( 'Update Client Category', 'clean-testimonials' ),
			'add_new_item' => __( 'Add New Client Category', 'clean-testimonials' ),
			'new_item_name' => __( 'New Client Category', 'clean-testimonials' ),
	...
	public static function testimonial_taxonomy_columns ( $columns ) {
		...
		return array(
			...
			'posts' => __( 'Clients', 'clean-testimonials' )
	...
	public static function testimonial_metabox ( $post ) {
		...
		<table class="testimonial-client-details">
			...
			<tr>
				...
				<td valign="middle" align="left"><em><?php _e( 'The name of the client', 'clean-testimonials' ); ?></em></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td valign="middle" align="left"><em><?php _e( 'Contact email address', 'clean-testimonials' ); ?></em></td>
			</tr>
			<tr>
				...
				<td valign="middle" align="left"><em><?php _e( 'Website', 'clea-testimonials' ); ?></em></td>
			</tr>
